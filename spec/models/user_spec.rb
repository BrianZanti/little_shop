...
RSpec.describe User, type: :model do
  ...
  describe "state and city statistics" do
    before :each do
      @u1 = create(:user)
      @u2 = create(:user)
      @u3 = create(:user)
    ...
    it ".top_address_states_by_order_count" do
      expect(User.top_address_states_by_order_count(3)[0].state).to eq("CO")
      expect(User.top_address_states_by_order_count(3)[0].order_count).to eq(11)
      expect(User.top_address_states_by_order_count(3)[1].state).to eq("CO")
      expect(User.top_address_states_by_order_count(3)[1].order_count).to eq(3)
      expect(User.top_address_states_by_order_count(3)[2].state).to eq("OK")
      expect(User.top_address_states_by_order_count(3)[2].order_count).to eq(2)
    end
    ...
    it ".top_address_cities_by_order_count" do
      ...
      expect(User.top_address_cities_by_order_count(3)[0].order_count).to eq(11)
      expect(User.top_address_cities_by_order_count(3)[1].state).to eq("CO")
      expect(User.top_address_cities_by_order_count(3)[1].city).to eq("Anywhere")
      expect(User.top_address_cities_by_order_count(3)[1].order_count).to eq(3)
      expect(User.top_address_cities_by_order_count(3)[2].state).to eq("IA")
      expect(User.top_address_cities_by_order_count(3)[2].city).to eq("Des Moines")
      expect(User.top_address_cities_by_order_count(3)[2].order_count).to eq(2)
    end
  end
end
