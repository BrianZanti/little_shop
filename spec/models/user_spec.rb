...
RSpec.describe User, type: :model do
  ...
  describe 'instance methods' do
    before :each do
      ...
      @a1 = create(:address, user_id: @u1.id, state: "CO", city: "Anywhere")
      @a1 = create(:address, user_id: @u2.id, state: "OK", city: "Tulsa")
      @a1 = create(:address, user_id: @u3.id, state: "IA", city: "Anywhere")
      @a1 = create(:address, user_id: u4.id, state: "IA", city: "Des Moines")
      @a1 = create(:address, user_id: u4.id, state: "IA", city: "Des Moines")
      @a1 = create(:address, user_id: u6.id, state: "IA", city: "Des Moines")
